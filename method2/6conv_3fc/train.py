# -*- coding: utf-8 -*-
"""
Created on Sat Dec 23 17:01:36 2017
...
#模型保存地址
model_path='E:/speaker_recognition_demo/method2/6conv_3fc/model/model.ckpt'
...
def inference(input_tensor, train, regularizer,num_classes):
    ...
    with tf.variable_scope("layer11-conv6"):
        conv6_weights = tf.get_variable("weight",[3,3,512,512],initializer=tf.truncated_normal_initializer(stddev=0.1))
        conv6_biases = tf.get_variable("bias", [512], initializer=tf.constant_initializer(0.0))
    ...
    with tf.variable_scope('layer15-fc3'):
...
logits = inference(x,False,regularizer,num_classes=8)
