  ...
  with tf.Session(graph=graph) as sess:
    ...
    for i in range(FLAGS.how_many_training_steps):
      ...
      if (i % FLAGS.eval_step_interval) == 0 or is_last_step:
        ...
        with open('E:\speaker_recognition_demo\method2\\result\\train_all_bz128_2.txt','a') as file_handle:
        ...
        with open('E:\speaker_recognition_demo\method2\\result\\validation_all_bz128_2.txt','a') as file_handle:
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='E:/speaker_recognition_demo/method2/dataset_all_images',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='E:/speaker_recognition_demo/method2/tmp/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='E:/speaker_recognition_demo/method2/tmp/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='E:/speaker_recognition_demo/method2/tmp/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='E:/speaker_recognition_demo/method2/tmp/retrain_log',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='E:/speaker_recognition_demo/method2/tmp/bottleneck',
  ...
  parser.add_argument(
      '--saved_model_dir',
      type=str,
      default='E:/speaker_recognition_demo/method2/tmp/saved_models/1/',
